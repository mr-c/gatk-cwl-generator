...
- doc: Minimum number of bases that pass filters
  ...
  type: int?
  inputBinding:
    prefix: --minDepthOfNonFilteredBase
- doc: Minimum number of bases that pass filters
  id: minDepthOfNonFilteredBase
  type: int?
  inputBinding:
...
- doc: Undocumented option
  ...
  type: File
  inputBinding:
    valueFrom: $(applyTagsToArgument("--sitesVCFFile", inputs['sitesVCFFile_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'sitesVCFFile'
  id: sitesVCFFile_tags
- doc: Undocumented option
  id: sitesVCFFile
  type: File
  inputBinding:
