...
- doc: file containing the BQSR second-pass report file
  ...
  type: File?
  inputBinding:
    valueFrom: $(applyTagsToArgument("--afterReportFile", inputs['afterReportFile_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'afterReportFile'
  id: afterReportFile_tags
- doc: file containing the BQSR second-pass report file
  id: afterReportFile
  type: File?
  inputBinding:
...
- doc: file containing the BQSR first-pass report file
  ...
  type: File?
  inputBinding:
    valueFrom: $(applyTagsToArgument("--beforeReportFile", inputs['beforeReportFile_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'beforeReportFile'
  id: beforeReportFile_tags
- doc: file containing the BQSR first-pass report file
  id: beforeReportFile
  type: File?
  inputBinding:
...
- type:
  ...
  doc: A argument to set the tags of 'beforeReportFile'
  id: beforeReportFile_tags
- doc: do not emit warning messages related to suspicious last modification time order
    of inputs
  id: ignoreLastModificationTimes
  type: boolean?
  inputBinding:
    prefix: --ignoreLastModificationTimes
- doc: do not emit warning messages related to suspicious last modification time order
    of inputs
  id: ignoreLastModificationTimes
  type: boolean?
...
- doc: location of the csv intermediate file
  ...
  type: File?
  inputBinding:
    valueFrom: $(applyTagsToArgument("--intermediateCsvFile", inputs['intermediateCsvFile_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'intermediateCsvFile'
  id: intermediateCsvFile_tags
- doc: location of the csv intermediate file
  id: intermediateCsvFile
  type: File?
  inputBinding:
...
- doc: location of the output report
  ...
  type: File?
  inputBinding:
    valueFrom: $(applyTagsToArgument("--plotsReportFile", inputs['plotsReportFile_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'plotsReportFile'
  id: plotsReportFile_tags
- doc: location of the output report
  id: plotsReportFile
  type: File?
  inputBinding:
