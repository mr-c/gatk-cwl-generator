...
- doc: File to which variants should be written
  ...
  inputBinding:
    prefix: --out
- doc: the VCF containing large populations of samples
  id: population
  type: File
  inputBinding:
    valueFrom: $(applyTagsToArgument("--population", inputs['population_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'population'
  id: population_tags
- doc: the VCF containing large populations of samples
  id: population
  type: File
