...
- doc: The name of the read group to keep, filtering out all others
  ...
  inputBinding:
    prefix: --read_group_to_keep
- doc: If provided, the attributes of the output VCF will only contain the somatic
    status fields
  id: minimalVCF
  type: boolean?
  inputBinding:
...
- type:
  ...
  doc: A argument to set the tags of 'out'
  id: out_tags
- doc: Phred-scaled min probability that a site should be called somatic mutation
  id: somaticMinLOD
  type: int?
  inputBinding:
    prefix: --somaticMinLOD
- doc: Phred-scaled min probability that a site should be called somatic mutation
  id: somaticMinLOD
  type: int?
  inputBinding:
    prefix: --somaticMinLOD
- doc: Phred-scaled probability that a site is a somatic mutation
  id: somaticPriorQ
  type: int?
  inputBinding:
    prefix: --somaticPriorQ
- doc: Phred-scaled probability that a site is a somatic mutation
  id: somaticPriorQ
  type: int?
  inputBinding:
