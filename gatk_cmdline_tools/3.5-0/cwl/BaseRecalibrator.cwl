...
- doc: BQSR BAQ gap open penalty (Phred Scaled).  Default value is 40.  30 is perhaps
  ...
  inputBinding:
    prefix: --bqsrBAQGapOpenPenalty
- doc: One or more covariates to be used in the recalibration. Can be specified multiple
    times
  id: covariate
  type:
  - 'null'
  ...
  - string
  inputBinding:
    valueFrom: $(generateArrayCmd("--covariate"))
- doc: One or more covariates to be used in the recalibration. Can be specified multiple
    times
  id: covariate
  type:
...
- doc: A database of known polymorphic sites
  ...
  - File
  inputBinding:
    valueFrom: $(applyTagsToArgument("--knownSites", inputs['knownSites_tags']))
- type:
  - 'null'
  - type: array
    items:
    ...
    - type: array
      items: string
  doc: A argument to set the tags of 'knownSites'
  id: knownSites_tags
- doc: A database of known polymorphic sites
  id: knownSites
  type:
