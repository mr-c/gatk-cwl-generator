...
- doc: Maximum read depth before a locus is considered poorly mapped
  ...
  inputBinding:
    prefix: --maxDepth
- doc: If the fraction of reads at a base with low mapping quality exceeds this value,
    the site may be poorly mapped
  id: maxFractionOfReadsWithLowMAPQ
  type: double?
  inputBinding:
    prefix: --maxFractionOfReadsWithLowMAPQ
- doc: If the fraction of reads at a base with low mapping quality exceeds this value,
    the site may be poorly mapped
  id: maxFractionOfReadsWithLowMAPQ
  type: double?
...
- doc: Minimum QC+ read depth before a locus is considered callable
  ...
  inputBinding:
    prefix: --minDepth
- doc: Minimum read depth before a locus is considered a potential candidate for poorly
    mapped
  id: minDepthForLowMAPQ
  type: int?
  inputBinding:
    prefix: --minDepthForLowMAPQ
- doc: Minimum read depth before a locus is considered a potential candidate for poorly
    mapped
  id: minDepthForLowMAPQ
  type: int?
...
- doc: Name of file for output summary
  ...
  type: File
  inputBinding:
    valueFrom: $(applyTagsToArgument("--summary", inputs['summary_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'summary'
  id: summary_tags
- doc: Name of file for output summary
  id: summary
  type: File
