...
- doc: The name of the read group to keep, filtering out all others
  ...
  inputBinding:
    prefix: --read_group_to_keep
- doc: One or more specific annotations to recompute.  The single value 'none' removes
...
- doc: One or more specific annotations to recompute.  The single value 'none' removes
  ...
  inputBinding:
    valueFrom: $(generateArrayCmd("--annotation"))
- doc: If > 0, reference bands will be broken up at genomic positions that are multiples
    of this number
  id: breakBandsAtMultiplesOf
  type: int?
  inputBinding:
    prefix: --breakBandsAtMultiplesOf
- doc: If > 0, reference bands will be broken up at genomic positions that are multiples
    of this number
  id: breakBandsAtMultiplesOf
  type: int?
...
- doc: If specified, convert banded gVCFs to all-sites gVCFs
  ...
  type: boolean?
  inputBinding:
    prefix: --convertToBasePairResolution
- doc: If specified, convert banded gVCFs to all-sites gVCFs
  id: convertToBasePairResolution
  type: boolean?
  inputBinding:
