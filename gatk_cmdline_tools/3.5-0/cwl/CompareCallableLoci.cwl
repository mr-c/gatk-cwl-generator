...
- doc: First comparison track name
  ...
  type: File
  inputBinding:
    valueFrom: $(applyTagsToArgument("--comp1", inputs['comp1_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'comp1'
  id: comp1_tags
- doc: First comparison track name
  id: comp1
  type: File
...
- doc: Second comparison track name
  ...
  type: File
  inputBinding:
    valueFrom: $(applyTagsToArgument("--comp2", inputs['comp2_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'comp2'
  id: comp2_tags
- doc: Second comparison track name
  id: comp2
  type: File
