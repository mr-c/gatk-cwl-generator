...
- doc: which approach should we take to getting the genotypes (only in array-free
    mode)
  id: genotype_mode
  type:
  - 'null'
...
- doc: the genotype information for our sample
  ...
  type: File?
  inputBinding:
    valueFrom: $(applyTagsToArgument("--genotypes", inputs['genotypes_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'genotypes'
  id: genotypes_tags
- doc: the genotype information for our sample
  id: genotypes
  type: File?
...
- type:
  ...
  doc: A argument to set the tags of 'genotypes'
  id: genotypes_tags
- doc: set to META (default), SAMPLE or READGROUP to produce per-bam, per-sample or
    per-lane estimates
  ...
  - type: enum
    ...
    - READGROUP
  inputBinding:
    valueFrom: $(generateArrayCmd("--lane_level_contamination"))
- doc: set to META (default), SAMPLE or READGROUP to produce per-bam, per-sample or
    per-lane estimates
  id: lane_level_contamination
  type:
...
- doc: threshold for minimum base quality score
  ...
  inputBinding:
    prefix: --min_qscore
- doc: what minimum number of bases do we need to see to call contamination in a lane
    / sample?
...
- doc: the variant file containing information about the population allele frequencies
  ...
  type: File
  inputBinding:
    valueFrom: $(applyTagsToArgument("--popfile", inputs['popfile_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'popfile'
  id: popfile_tags
- doc: the variant file containing information about the population allele frequencies
  id: popfile
  type: File
...
- doc: evaluate contamination for just a single contamination population
  ...
  inputBinding:
    prefix: --population
- doc: the degree of precision to which the contamination tool should estimate (e.g.
    the bin size)
  id: precision
  type: double?
  inputBinding:
...
- doc: the degree of precision to which the contamination tool should estimate (e.g.
  ...
  inputBinding:
    prefix: --precision
- doc: The sample name; used to extract the correct genotypes from mutli-sample truth
    vcfs
  id: sample_name
  type: string?
  inputBinding:
