...
- doc: Input VCF file(s)
  ...
  - File
  inputBinding:
    valueFrom: $(applyTagsToArgument("--rod", inputs['rod_tags']))
- type:
  - 'null'
  - type: array
    items:
    ...
    - type: array
      items: string
  doc: A argument to set the tags of 'rod'
  id: rod_tags
- doc: Input VCF file(s)
  id: rod
  type:
...
- doc: If true, this tool will print out the skipped locations
  ...
  inputBinding:
    prefix: --showSkipped
- doc: If true, this tool will print out detailed information about the rods it finds
    and locations
  id: verbose
  type: boolean?
  inputBinding:
