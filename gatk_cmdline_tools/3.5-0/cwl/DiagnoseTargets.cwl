...
- doc: The proportion of the loci needed for calling BAD_MATE
  ...
  type: double?
  inputBinding:
    prefix: --bad_mate_status_threshold
- doc: The proportion of the loci needed for calling BAD_MATE
  id: bad_mate_status_threshold
  type: double?
  inputBinding:
...
- doc: The proportion of the loci needed for calling LOW_COVERAGE and COVERAGE_GAPS
  ...
  type: double?
  inputBinding:
    prefix: --coverage_status_threshold
- doc: The proportion of the loci needed for calling LOW_COVERAGE and COVERAGE_GAPS
  id: coverage_status_threshold
  type: double?
  inputBinding:
...
- doc: The proportion of the loci needed for calling EXCESSIVE_COVERAGE
  ...
  type: double?
  inputBinding:
    prefix: --excessive_coverage_status_threshold
- doc: The proportion of the loci needed for calling EXCESSIVE_COVERAGE
  id: excessive_coverage_status_threshold
  type: double?
  inputBinding:
...
- doc: Produces a file with the intervals that don't pass filters
  ...
  type: File?
  inputBinding:
    valueFrom: $(applyTagsToArgument("--missing_intervals", inputs['missing_intervals_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'missing_intervals'
  id: missing_intervals_tags
- doc: Produces a file with the intervals that don't pass filters
  id: missing_intervals
  type: File?
  inputBinding:
...
- doc: The proportion of the loci needed for calling POOR_QUALITY
  ...
  type: double?
  inputBinding:
    prefix: --quality_status_threshold
- doc: The proportion of the loci needed for calling POOR_QUALITY
  id: quality_status_threshold
  type: double?
  inputBinding:
    prefix: --quality_status_threshold
- doc: 'The needed proportion of samples containing a call for the interval to adopt
    the call '
  id: voting_status_threshold
  type: double?
  inputBinding:
    prefix: --voting_status_threshold
- doc: 'The needed proportion of samples containing a call for the interval to adopt
    the call '
  id: voting_status_threshold
  type: double?
