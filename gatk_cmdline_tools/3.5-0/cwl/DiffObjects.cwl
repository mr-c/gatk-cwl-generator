...
- doc: The name of the read group to keep, filtering out all others
  ...
  inputBinding:
    prefix: --read_group_to_keep
- doc: If provided, we will compute the minimum pairwise differences to summary, which
...
- doc: 'Master file: expected results'
  ...
  type: File
  inputBinding:
    valueFrom: $(applyTagsToArgument("--master", inputs['master_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'master'
  id: master_tags
- doc: 'Master file: expected results'
  id: master
  type: File
...
- doc: Should we enumerate all differences between the files?
  ...
  type: boolean?
  inputBinding:
    prefix: --showItemizedDifferences
- doc: Should we enumerate all differences between the files?
  id: showItemizedDifferences
  type: boolean?
  inputBinding:
...
- doc: 'Test file: new results to compare to the master file'
  ...
  type: File
  inputBinding:
    valueFrom: $(applyTagsToArgument("--test", inputs['test_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'test'
  id: test_tags
- doc: 'Test file: new results to compare to the master file'
  id: test
  type: File
