...
doc: |2-
    Allows us to test that the engine is behaving as expected with error handling
requirements:
...
- doc: The name of the read group to keep, filtering out all others
  ...
  inputBinding:
    prefix: --read_group_to_keep
- doc: Java class of exception to throw
  id: exception
  type: string
  inputBinding:
    prefix: --exception
- doc: Java class of exception to throw
  ...
  inputBinding:
    prefix: --exception
- doc: Determines which method to fail in
  id: failMethod
  type:
  - 'null'
  - type: enum
