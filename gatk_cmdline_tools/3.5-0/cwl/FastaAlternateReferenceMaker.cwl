id: FastaAlternateReferenceMaker
cwlVersion: v1.0
baseCommand:
- java
- -jar
...
- doc: The name of the read group to keep, filtering out all others
  ...
  inputBinding:
    prefix: --read_group_to_keep
- doc: Maximum length of sequence to write per line
  id: lineWidth
  type: int?
  inputBinding:
    prefix: --lineWidth
...
- type:
  ...
  doc: A argument to set the tags of 'out'
  id: out_tags
- doc: Print sequences with no FASTA header lines, one line per interval (i.e. lineWidth
    = infinity)
  id: rawOnelineSeq
  type: boolean?
  inputBinding:
    prefix: --rawOnelineSeq
- doc: Print sequences with no FASTA header lines, one line per interval (i.e. lineWidth
    = infinity)
  id: rawOnelineSeq
  type: boolean?
  inputBinding:
    prefix: --rawOnelineSeq
- doc: SNP mask VCF file
  id: snpmask
  type: File?
  inputBinding:
    valueFrom: $(applyTagsToArgument("--snpmask", inputs['snpmask_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'snpmask'
  id: snpmask_tags
- doc: SNP mask VCF file
  id: snpmask
  type: File?
...
- type:
  ...
  doc: A argument to set the tags of 'snpmask'
  id: snpmask_tags
- doc: SNP mask priority
  id: snpmaskPriority
  type: boolean?
  inputBinding:
    prefix: --snpmaskPriority
- doc: SNP mask priority
  id: snpmaskPriority
  type: boolean?
  inputBinding:
    prefix: --snpmaskPriority
- doc: If specified, heterozygous SNP sites will be output using IUPAC ambiguity codes
    given the genotypes for this sample
  id: use_IUPAC_sample
  type: string?
  inputBinding:
    prefix: --use_IUPAC_sample
- doc: If specified, heterozygous SNP sites will be output using IUPAC ambiguity codes
    given the genotypes for this sample
  id: use_IUPAC_sample
  type: string?
