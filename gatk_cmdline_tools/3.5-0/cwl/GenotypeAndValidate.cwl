...
- doc: The name of the read group to keep, filtering out all others
  ...
  inputBinding:
    prefix: --read_group_to_keep
- doc: The set of alleles at which to genotype
  id: alleles
  type: File
  inputBinding:
...
- type:
  ...
  doc: A argument to set the tags of 'alleles'
  id: alleles_tags
- doc: Condition validation on a minimum depth of coverage by the reads
  id: condition_on_depth
  type: int?
  inputBinding:
    prefix: --condition_on_depth
- doc: Condition validation on a minimum depth of coverage by the reads
  id: condition_on_depth
  type: int?
  inputBinding:
    prefix: --condition_on_depth
- doc: Maximum deletion fraction for calling a genotype
  id: maximum_deletion_fraction
  type: double?
  inputBinding:
    prefix: --maximum_deletion_fraction
- doc: Maximum deletion fraction for calling a genotype
  id: maximum_deletion_fraction
  type: double?
  inputBinding:
    prefix: --maximum_deletion_fraction
- doc: Minimum base quality score for calling a genotype
  id: minimum_base_quality_score
  type: int?
  inputBinding:
    prefix: --minimum_base_quality_score
- doc: Minimum base quality score for calling a genotype
  id: minimum_base_quality_score
  type: int?
  inputBinding:
    prefix: --minimum_base_quality_score
- doc: Output VCF file with annotated variants
  id: outFilename
  type: File?
  inputBinding:
...
- type:
  ...
  doc: A argument to set the tags of 'out'
  id: out_tags
- doc: Use the calls on the reads (bam file) as the truth dataset and validate the
    calls on the VCF
  id: set_bam_truth
  type: boolean?
  inputBinding:
    prefix: --set_bam_truth
- doc: Use the calls on the reads (bam file) as the truth dataset and validate the
    calls on the VCF
  id: set_bam_truth
  type: boolean?
  inputBinding:
    prefix: --set_bam_truth
- doc: the minimum phred-scaled Qscore threshold to separate high confidence from
...
- doc: the minimum phred-scaled Qscore threshold to separate high confidence from
  ...
  inputBinding:
    prefix: --standard_min_confidence_threshold_for_calling
- doc: the minimum phred-scaled Qscore threshold to emit low confidence calls
