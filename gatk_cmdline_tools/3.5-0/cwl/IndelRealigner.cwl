...
- doc: Determines how to compute the possible alternate consenses
  ...
  inputBinding:
    prefix: --consensusDeterminationModel
- doc: Percentage of mismatches at a locus to be considered having high entropy (0.0
    < entropy <= 1.0)
  id: entropyThreshold
  type: double?
  inputBinding:
...
- doc: Input VCF file(s) with known indels
  ...
  - File
  inputBinding:
    valueFrom: $(applyTagsToArgument("--knownAlleles", inputs['knownAlleles_tags']))
- type:
  - 'null'
  - type: array
    items:
    ...
    - type: array
      items: string
  doc: A argument to set the tags of 'knownAlleles'
  id: knownAlleles_tags
- doc: Input VCF file(s) with known indels
  id: knownAlleles
  type:
  - 'null'
...
- doc: max reads allowed to be kept in memory at a time by the SAMFileWriter
  ...
  inputBinding:
    prefix: --maxReadsInMemory
- doc: Don't output the original cigar or alignment start tags for each realigned
...
- doc: Generate one output file for each input (-I) bam file (not compatible with
  ...
  type: File?
  inputBinding:
    valueFrom: $(applyTagsToArgument("--nWayOut", inputs['nWayOut_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'nWayOut'
  id: nWayOut_tags
- doc: Generate one output file for each input (-I) bam file (not compatible with
    -output)
  id: nWayOutFilename
...
- doc: Intervals file output from RealignerTargetCreator
  ...
  - File
  inputBinding:
    valueFrom: $(applyTagsToArgument("--targetIntervals", inputs['targetIntervals_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'targetIntervals'
  id: targetIntervals_tags
- doc: Intervals file output from RealignerTargetCreator
  id: targetIntervals
  type:
  - File
...
outputs:
- id: nWayOut
  doc: Output file from corresponding to the input argument nWayOutFilename
  type: File?
  outputBinding:
    glob: $(inputs['nWayOutFilename'])
- id: nWayOut
  doc: Output file from corresponding to the input argument nWayOutFilename
  type: File?
  outputBinding:
