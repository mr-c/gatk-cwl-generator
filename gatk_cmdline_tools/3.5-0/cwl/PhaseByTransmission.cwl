...
- doc: 'Prior for de novo mutations. Default: 1e-8'
  ...
  inputBinding:
    prefix: --DeNovoPrior
- doc: Ouputs the father allele as the first allele in phased child genotype. i.e.
    father|mother rather than mother|father.
  id: FatherAlleleFirst
  type: boolean?
  inputBinding:
    prefix: --FatherAlleleFirst
- doc: Ouputs the father allele as the first allele in phased child genotype. i.e.
    father|mother rather than mother|father.
  id: FatherAlleleFirst
  type: boolean?
...
- doc: File to output the mendelian violation details.
  ...
  type: string?
  inputBinding:
    prefix: --MendelianViolationsFile
- doc: File to output the mendelian violation details.
  id: MendelianViolationsFile
  type: string?
  inputBinding:
