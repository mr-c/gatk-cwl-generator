...
- doc: The name of the read group to keep, filtering out all others
  ...
  inputBinding:
    prefix: --read_group_to_keep
- doc: Fraction of records to be placed in out1 (must be 0 >= fraction <= 1); all
    other records are placed in out2
  id: fractionToOut1
  type: double?
  inputBinding:
    prefix: --fractionToOut1
- doc: Fraction of records to be placed in out1 (must be 0 >= fraction <= 1); all
    other records are placed in out2
  id: fractionToOut1
  type: double?
...
- doc: 'File #2 to which variants should be written'
  ...
  type: File?
  inputBinding:
    valueFrom: $(applyTagsToArgument("--out2", inputs['out2_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'out2'
  id: out2_tags
- doc: 'File #2 to which variants should be written'
  id: out2
  type: File?
...
- type:
  ...
  doc: A argument to set the tags of 'out2'
  id: out2_tags
- doc: 'the name of the output VCF file will be: <baseOutputName>.split.<number>.vcf.
    Required with SplitToMany option'
  id: prefixForAllOutputFileNames
  type: string?
  inputBinding:
    prefix: --prefixForAllOutputFileNames
- doc: 'the name of the output VCF file will be: <baseOutputName>.split.<number>.vcf.
    Required with SplitToMany option'
  id: prefixForAllOutputFileNames
  type: string?
  inputBinding:
    prefix: --prefixForAllOutputFileNames
- doc: split (with uniform distribution) to more than 2 files. numOfFiles and baseOutputName
    parameters are required
  id: splitToManyFiles
  type: boolean?
  inputBinding:
    prefix: --splitToManyFiles
- doc: split (with uniform distribution) to more than 2 files. numOfFiles and baseOutputName
    parameters are required
  id: splitToManyFiles
  type: boolean?
...
outputs:
- id: out1
  doc: Output file from corresponding to the input argument out1Filename
  type: File?
  outputBinding:
    glob: $(inputs['out1Filename'])
- id: out1
  doc: Output file from corresponding to the input argument out1Filename
  type: File?
  outputBinding:
