...
- doc: The name of the read group to keep, filtering out all others
  ...
  inputBinding:
    prefix: --read_group_to_keep
- doc: The window size (in bases) to cache variant sites and their reads for the phasing
    procedure
  id: cacheWindowSize
  type: int?
  inputBinding:
    prefix: --cacheWindowSize
- doc: The window size (in bases) to cache variant sites and their reads for the phasing
    procedure
  id: cacheWindowSize
  type: int?
  inputBinding:
    prefix: --cacheWindowSize
- doc: If specified, print out very verbose debug information (if -l DEBUG is also
    specified)
  id: debug
  type: boolean?
  inputBinding:
...
- doc: Merge consecutive phased sites into MNP records
  ...
  type: boolean?
  inputBinding:
    prefix: --enableMergePhasedSegregatingPolymorphismsToMNP
- doc: Merge consecutive phased sites into MNP records
  id: enableMergePhasedSegregatingPolymorphismsToMNP
  type: boolean?
  inputBinding:
    prefix: --enableMergePhasedSegregatingPolymorphismsToMNP
- doc: The maximum reference-genome distance between consecutive heterozygous sites
    to permit merging phased VCF records into a MNP record
  id: maxGenomicDistanceForMNP
  type: int?
  inputBinding:
    prefix: --maxGenomicDistanceForMNP
- doc: The maximum reference-genome distance between consecutive heterozygous sites
    to permit merging phased VCF records into a MNP record
  id: maxGenomicDistanceForMNP
  type: int?
  inputBinding:
    prefix: --maxGenomicDistanceForMNP
- doc: The maximum number of successive heterozygous sites permitted to be used by
    the phasing algorithm
  id: maxPhaseSites
  type: int?
  inputBinding:
    prefix: --maxPhaseSites
- doc: The maximum number of successive heterozygous sites permitted to be used by
    the phasing algorithm
  id: maxPhaseSites
  type: int?
...
- doc: Only include these samples when phasing
  ...
  - string
  inputBinding:
    valueFrom: $(generateArrayCmd("--sampleToPhase"))
- doc: Only include these samples when phasing
  id: sampleToPhase
  type:
  - 'null'
