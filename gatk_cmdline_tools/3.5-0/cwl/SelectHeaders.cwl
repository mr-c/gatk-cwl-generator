...
- doc: Exclude header. Can be specified multiple times
  ...
  - string
  inputBinding:
    valueFrom: $(generateArrayCmd("--exclude_header_name"))
- doc: Exclude header. Can be specified multiple times
  id: exclude_header_name
  type:
  - 'null'
  ...
  inputBinding:
    valueFrom: $(generateArrayCmd("--exclude_header_name"))
- doc: Regular expression to select many headers from the tracks provided. Can be
  ...
  - string
  inputBinding:
    valueFrom: $(generateArrayCmd("--header_expression"))
- doc: Regular expression to select many headers from the tracks provided. Can be
    specified multiple times
  id: header_expression
  type:
...
- doc: Include header. Can be specified multiple times
  ...
  - string
  inputBinding:
    valueFrom: $(generateArrayCmd("--header_name"))
- doc: Include header. Can be specified multiple times
  id: header_name
  type:
  - 'null'
  ...
  inputBinding:
    valueFrom: $(generateArrayCmd("--header_name"))
- doc: If set the interval file name minus the file extension, or the command line
    intervals, will be added to the headers
  id: include_interval_names
  type: boolean?
  inputBinding:
    prefix: --include_interval_names
- doc: If set the interval file name minus the file extension, or the command line
    intervals, will be added to the headers
  id: include_interval_names
  type: boolean?
