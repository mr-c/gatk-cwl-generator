...
- doc: One or more specific expressions to apply to variant calls
  ...
  - string
  inputBinding:
    valueFrom: $(generateArrayCmd("--expression"))
- doc: One or more specific expressions to apply to variant calls
  id: expression
  type:
  - 'null'
...
- doc: GQ threshold for annotating MV ratio
  ...
  type: double?
  inputBinding:
    prefix: --MendelViolationGenotypeQualityThreshold
- doc: GQ threshold for annotating MV ratio
  id: MendelViolationGenotypeQualityThreshold
  type: double?
  inputBinding:
...
- doc: Check for allele concordances when using an external resource VCF file
  ...
  type: boolean?
  inputBinding:
    prefix: --resourceAlleleConcordance
- doc: Check for allele concordances when using an external resource VCF file
  id: resourceAlleleConcordance
  type: boolean?
  inputBinding:
...
- doc: SnpEff file from which to get annotations
  ...
  type: File?
  inputBinding:
    valueFrom: $(applyTagsToArgument("--snpEffFile", inputs['snpEffFile_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'snpEffFile'
  id: snpEffFile_tags
- doc: SnpEff file from which to get annotations
  id: snpEffFile
  type: File?
