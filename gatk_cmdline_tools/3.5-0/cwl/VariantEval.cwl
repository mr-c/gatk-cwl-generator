...
- doc: Fasta file with ancestral alleles
  ...
  type: File?
  inputBinding:
    valueFrom: $(applyTagsToArgument("--ancestralAlignments", inputs['ancestralAlignments_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'ancestralAlignments'
  id: ancestralAlignments_tags
- doc: Fasta file with ancestral alleles
  id: ancestralAlignments
  type: File?
  inputBinding:
...
- type:
  ...
  doc: A argument to set the tags of 'dbsnp'
  id: dbsnp_tags
- doc: Do not use the standard modules by default (instead, only those that are specified
    with the -EV option)
  id: doNotUseAllStandardModules
  type: boolean?
  inputBinding:
    prefix: --doNotUseAllStandardModules
- doc: Do not use the standard modules by default (instead, only those that are specified
    with the -EV option)
  id: doNotUseAllStandardModules
  type: boolean?
  inputBinding:
    prefix: --doNotUseAllStandardModules
- doc: Do not use the standard stratification modules by default (instead, only those
    that are specified with the -S option)
  id: doNotUseAllStandardStratifications
  type: boolean?
  inputBinding:
    prefix: --doNotUseAllStandardStratifications
- doc: Do not use the standard stratification modules by default (instead, only those
    that are specified with the -S option)
  id: doNotUseAllStandardStratifications
  type: boolean?
...
- doc: One or more specific eval modules to apply to the eval track(s) (in addition
    to the standard modules, unless -noEV is specified)
  id: evalModule
  type:
  - 'null'
  - type: array
  ...
  - string
  inputBinding:
    valueFrom: $(generateArrayCmd("--evalModule"))
- doc: One or more specific eval modules to apply to the eval track(s) (in addition
    to the standard modules, unless -noEV is specified)
  id: evalModule
  type:
  ...
  inputBinding:
    valueFrom: $(generateArrayCmd("--evalModule"))
- doc: Evaluations that count calls at sites of true variation (e.g., indel calls)
    will use this argument as their gold standard for comparison
  id: goldStandard
  type: File?
  inputBinding:
    valueFrom: $(applyTagsToArgument("--goldStandard", inputs['goldStandard_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'goldStandard'
  id: goldStandard_tags
- doc: Evaluations that count calls at sites of true variation (e.g., indel calls)
    will use this argument as their gold standard for comparison
  id: goldStandard
  type: File?
...
- type:
  ...
  doc: A argument to set the tags of 'goldStandard'
  id: goldStandard_tags
- doc: If provided, modules that track polymorphic sites will not require that a site
    have AC > 0 when the input eval has genotypes
  id: keepAC0
  type: boolean?
  inputBinding:
    prefix: --keepAC0
- doc: If provided, modules that track polymorphic sites will not require that a site
  ...
  inputBinding:
    prefix: --keepAC0
- doc: Name of ROD bindings containing variant sites that should be treated as known
    when splitting eval rods into known and novel subsets
  id: known_names
  type:
  - 'null'
  - type: array
  ...
  - string
  inputBinding:
    valueFrom: $(generateArrayCmd("--known_names"))
- doc: Name of ROD bindings containing variant sites that should be treated as known
    when splitting eval rods into known and novel subsets
  id: known_names
  type:
  ...
  inputBinding:
    valueFrom: $(generateArrayCmd("--known_names"))
- doc: File containing tribble-readable features describing a known list of copy number
    variants
  id: knownCNVs
  type:
  - 'null'
  ...
  - string
  inputBinding:
    valueFrom: $(applyTagsToArgument("--knownCNVs", inputs['knownCNVs_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'knownCNVs'
  id: knownCNVs_tags
- doc: File containing tribble-readable features describing a known list of copy number
    variants
  id: knownCNVs
...
- doc: List the available eval modules and exit
  ...
  inputBinding:
    prefix: --list
- doc: Minimum genotype QUAL score for each trio member required to accept a site
    as a violation. Default is 50.
...
- type:
  ...
  doc: A argument to set the tags of 'out'
  id: out_tags
- doc: If provided only comp and eval tracks with exactly matching reference and alternate
    alleles will be counted as overlapping
  id: requireStrictAlleleMatch
  type: boolean?
  inputBinding:
    prefix: --requireStrictAlleleMatch
- doc: If provided only comp and eval tracks with exactly matching reference and alternate
    alleles will be counted as overlapping
  id: requireStrictAlleleMatch
  type: boolean?
  inputBinding:
    prefix: --requireStrictAlleleMatch
- doc: Derive eval and comp contexts using only these sample genotypes, when genotypes
    are available in the original context
  id: sample
  type:
  - 'null'
  - type: array
...
- doc: One or more stratifications to use when evaluating the data
  ...
  - string
  inputBinding:
    valueFrom: $(generateArrayCmd("--select_exps"))
- doc: One or more stratifications to use when evaluating the data
  id: select_exps
  type:
  - 'null'
...
- doc: Names to use for the list of stratifications (must be a 1-to-1 mapping)
  ...
  - string
  inputBinding:
    valueFrom: $(generateArrayCmd("--select_names"))
- doc: Names to use for the list of stratifications (must be a 1-to-1 mapping)
  id: select_names
  type:
  - 'null'
  ...
  inputBinding:
    valueFrom: $(generateArrayCmd("--select_names"))
- doc: One or more specific stratification modules to apply to the eval track(s) (in
    addition to the standard stratifications, unless -noS is specified)
  ...
  - string
  inputBinding:
    valueFrom: $(generateArrayCmd("--stratificationModule"))
- doc: One or more specific stratification modules to apply to the eval track(s) (in
    addition to the standard stratifications, unless -noS is specified)
  id: stratificationModule
  type:
...
- doc: File containing tribble-readable features for the IntervalStratificiation
  ...
  - string
  inputBinding:
    valueFrom: $(applyTagsToArgument("--stratIntervals", inputs['stratIntervals_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'stratIntervals'
  id: stratIntervals_tags
- doc: File containing tribble-readable features for the IntervalStratificiation
  id: stratIntervals
  type:
  - 'null'
