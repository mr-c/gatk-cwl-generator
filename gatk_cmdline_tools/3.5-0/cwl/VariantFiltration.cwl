...
- doc: One or more expression used with INFO fields to filter
  ...
  - string
  inputBinding:
    valueFrom: $(generateArrayCmd("--filterExpression"))
- doc: One or more expression used with INFO fields to filter
  id: filterExpression
  type:
  - 'null'
...
- doc: Names to use for the list of filters
  ...
  - string
  inputBinding:
    valueFrom: $(generateArrayCmd("--filterName"))
- doc: Names to use for the list of filters
  id: filterName
  type:
  - 'null'
...
- doc: Filter records NOT in given input mask.
  ...
  inputBinding:
    prefix: --filterNotInMask
- doc: One or more expression used with FORMAT (sample/genotype-level) fields to filter
    (see documentation guide for more info)
  ...
  - string
  inputBinding:
    valueFrom: $(generateArrayCmd("--genotypeFilterExpression"))
- doc: One or more expression used with FORMAT (sample/genotype-level) fields to filter
    (see documentation guide for more info)
  id: genotypeFilterExpression
  type:
...
- doc: Names to use for the list of sample/genotype filters (must be a 1-to-1 mapping);
  ...
  - string
  inputBinding:
    valueFrom: $(generateArrayCmd("--genotypeFilterName"))
- doc: Names to use for the list of sample/genotype filters (must be a 1-to-1 mapping);
    this name is put in the FILTER field for variants that get filtered
  id: genotypeFilterName
  type:
...
- type:
  ...
  doc: A argument to set the tags of 'mask'
  id: mask_tags
- doc: How many bases beyond records from a provided 'mask' rod should variants be
    filtered
  id: maskExtension
  type: int?
  inputBinding:
...
- doc: How many bases beyond records from a provided 'mask' rod should variants be
  ...
  inputBinding:
    prefix: --maskExtension
- doc: The text to put in the FILTER field if a 'mask' rod is provided and overlaps
    with a variant call
  id: maskName
  type: string?
  inputBinding:
