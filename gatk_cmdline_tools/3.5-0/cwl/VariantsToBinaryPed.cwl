...
- doc: output bed file
  ...
  type: File
  inputBinding:
    valueFrom: $(applyTagsToArgument("--bed", inputs['bed_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'bed'
  id: bed_tags
- doc: output bed file
  id: bed
  type: File
...
- doc: output map file
  ...
  type: File
  inputBinding:
    valueFrom: $(applyTagsToArgument("--bim", inputs['bim_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'bim'
  id: bim_tags
- doc: output map file
  id: bim
  type: File
...
- type:
  ...
  doc: A argument to set the tags of 'bim'
  id: bim_tags
- doc: Checks that alternate alleles actually appear in samples, erroring out if they
    do not
  id: checkAlternateAlleles
  type: boolean?
  inputBinding:
    prefix: --checkAlternateAlleles
- doc: dbSNP file
  id: dbsnp
  type: File?
  inputBinding:
...
- doc: output fam file
  ...
  type: File
  inputBinding:
    valueFrom: $(applyTagsToArgument("--fam", inputs['fam_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'fam'
  id: fam_tags
- doc: output fam file
  id: fam
  type: File
...
- type:
  ...
  doc: A argument to set the tags of 'fam'
  id: fam_tags
- doc: Sets the major allele to be 'reference' for the bim file, rather than the ref
    allele
  id: majorAlleleFirst
  type: boolean?
  inputBinding:
    prefix: --majorAlleleFirst
- doc: Sample metadata file
  id: metaData
  type: File
  inputBinding:
    valueFrom: $(applyTagsToArgument("--metaData", inputs['metaData_tags']))
- type:
  - 'null'
  - string
  - string[]
  doc: A argument to set the tags of 'metaData'
  id: metaData_tags
- doc: Sample metadata file
  id: metaData
  type: File
